...
\begin{frame}[plain]
  \begin{center}
    ...
    {\setlength{\fboxsep}{5pt}\setlength{\fboxrule}{0.6pt}\color{hairline}%
     \fbox{\includegraphics[width=6.4cm]{team_logo.png}}}\\[1.1em]
...
\begin{frame}{Background}
  \begin{itemize}
    \item The \textbf{AI-Kalman Filter} (Cellini et al.\ 2025) performs better than
      a standard Kalman filter for estimation.
    \vspace{0.6em}
...
\begin{frame}{Project Goals}
  \begin{enumerate}
    ...
    \item \textbf{Estimate on a collected trajectory} --- run the AI-KF estimator on
      ...
      reading.
    \item \textbf{Real-time altitude estimation} --- run the same estimator live on the Crazyflie \hfill \textcolor{tealc}{\scriptsize\textsc{[stretch goal]}}
...
% ---------------------------------------------------------------------------
\begin{frame}{Trained directly on the real flights}
...
% ---------------------------------------------------------------------------
\begin{frame}{State estimate on a collected trajectory}
  \centering
  \includegraphics[height=4.2cm]{/home/jaden/repos/ai_kalman_on_crazyflie/trajectory_analysis/real_accel_decel_a0.30_c0.50_y_rep0_20260709_184855_analysis.png}\\[0.2em]
\end{frame}

% ---------------------------------------------------------------------------
\begin{frame}{Live estimation demo}
  \centering
  \vspace{0.5em}
  \begin{tikzpicture}
